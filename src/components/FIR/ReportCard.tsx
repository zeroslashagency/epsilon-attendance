...
import { ShieldAlert, Mic, ArrowUpRight, CheckCircle2, Clock, AlertTriangle } from 'lucide-react';
            ...
            <div className="flex justify-between items-start mb-4">
                ...
                <div className="shrink-0">
                    {report.reporter.avatar ? (
                        ...
                        <div className="w-10 h-10 rounded-full bg-white/50 flex items-center justify-center text-sm font-bold border-2 border-white/50 text-slate-700">
